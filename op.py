...
NAME, VERSION, AUTHOR, LICENSE = " SQLi Scanner < CytoXploit >", "0.2", "Cyto Febryan", "https://www.cytoxploit.or.id/"

PREFIXES, SUFFIXES = (" ", ") ", "' ", "') "), ("", "-- -", "#", "%%16")            # Code ini sengaja dibuat bahasa Inggris biar belajar juga
TAMPER_SQL_CHAR_POOL = ('(', ')', '\'', '"')                                        # SQL ini sebatas scanning aja code sederhana Cyto Febryan
BOOLEAN_TESTS = ("AND %d=%d", "OR NOT (%d>%d)")                                     # Ntar di gabung sama Bash
COOKIE, UA, REFERER = "Cookie", "User-Agent", "Referer"                             # CytoXploit
GET, POST = "GET", "POST"                                                           
